...
class DirectSunSummaryTests(unittest.TestCase):
    def test_no_direct_sun_returns_off_summary(self) -> None:
        ...
        self.assertEqual(summary["moment_text"], "At the selected time, the sun does not enter the room.")
    ...
    def test_broad_coverage_summary(self) -> None:
        ...
        self.assertEqual(
            summary["moment_text"],
            "At the selected time, the sun enters the room but does not reach the floor.",
        )
